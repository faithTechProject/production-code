    ...
    return (
        <>
            ...
            <div className='body'>
                ...
                <h2>What is Demonstrate?</h2>
                <p>In this final stage of the 4D Cycle, we redine impact from the greatest amount of force in the shortest amount of time to friendship compounded by time. 
                ...
                <p>A myth of tech startup success is that the most impactful product and company achieves the greatest amount of force in the shortest amount of time.
                ...
                <p>Where i=impact, f=force, and t=time. <br></br>
                ...
                <p>Our impact is not demonstrated by the amount of force over time, but rather by the compounding of relationships over time- both as a team and with the community we are building to serve.
                ...
                <p>Where i=influence, f=friendship, and t=time. <br></br>
                    We suggest that this could also be considered "redemptive impact" (ri):
                </p>
                <p className={styles.oFormula}>
                    <b>ri = f<sup> t</sup></b>
                </p>
                <p>Redemptive impact begins with a counter-cultural force called friendship.
                ...
                <h2>Demonstrate Session</h2>
                <p className={styles.oCenteredText}>Watch this video with your team to learn more about the Demonstrate stage.
                    <br></br>
                </p>
