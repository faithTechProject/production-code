...
import '../stylesheets/discernOverview.css';
export function DiscernOverview() {
    return (
        <>
            <div class="obody1">
                <div id="oDiscernTopImage">
                    <h3 class="oTitle">DISCERN</h3>
                </div>
                <br></br>
                <br></br>
                <br></br>
            ...
            <div class="discernBody">
                <div id="o4Ddiscern"></div>
                <div class="oDiscernBox">
                    <p class="o2Dp2">
                        <b>Discern</b>
                    </p>
                    <p class="o2Dp2">
            ...
            <div class="obody2">
                <h2 class="o2Dh2">What is Discern?</h2>
                <p class="o2Dp1">
                ...
                <h2 class="o2Dh2">Discern Session</h2>
                <p class="o2Dp2">Watch this video with your team to learn more about the Discern stage.
                    <br></br>
                </p>
